...
print(Counter(li))  # Counter({2: 6, 1: 2, 3: 2, 4: 1, 5: 1, 7: 1})
print(
    Counter(sentence)
)  # Counter({'o': 6, '!': 5, ' ': 3, 'H': 2, 'e': 2, 'l': 2, 'w': 1, 'a': 1, 'r': 1, 'y': 1, 'u': 1})

# count the no. of occurrence of each iterable, and store them in a dict format,
